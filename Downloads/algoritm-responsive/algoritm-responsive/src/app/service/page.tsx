...
import Banking from '@/asset/images/banking.png'
import Data from '@/asset/images/dataTeck.png'
import Lend from '@/asset/images/lendTeck.png'
            ...
            <div className="w-full">
                {/* <section className="Banck flex justify-center flex-row-reverse pt-7">
                    ...
                    <div className="Right w-[60%]">
                        ...
                        <div dir="rtl" className="Desc text-right p-3 md:h-full md:flex md:flex-col md:mt-16 ">
                            ...
                            <div dir="ltr" className="w-full md:grid md:grid-cols-2 md:gap-y-4 md:gap-x-8 p-4 text-right hidden ">
                    ...
                    <div className="Left w-[40%] md:w-[30%] ">
                        <div className=' rounded-[10px]'>
                            <Image src={Banking} className="pt-24 w-full p-3 " alt="banking" />
                        </div>
                ...
                <div className="w-full grid grid-cols-2 gap-y-4 gap-x-8 p-4 text-right md:hidden">
                    <div className="flex flex-row-reverse gap-1.5 items-start">
                        <span className="w-2 h-2 mt-2 rounded-full bg-[#000446] "></span>
                        <span>داشبورد بانک داری هوشمند</span>
                    </div>
