  ...
  return (
    <div>
      ...
      <div className="text-right pt-8 ">
        ...
        <section className='About md:flex md:flex-row-reverse md:justify-around md:items-end'>
          <div>

            <p className='text-[20px] text-black pb-1 p-3'>:الگوریتم،پیشگام در دنیای داده و هوش مصنوعی</p>
