        ...
        <ul className="flex flex-col md:flex-row gap-8 p-6 md:p-0 md:gap-6 text-right">
          <li>
            <Link
              href="./" 
              onClick={() => setIsOpen(false)} 
              className={`md:hover:text-blue-500 hover:text-blue-500 ${
              pathname === '/' ? 'text-blue-500' : 'text-gray-700 md:text-white'
              }`}>
               خانه
            </Link>
          </li>
            ...
            <li>
              <Link
               ...
               onClick={()=> setIsOpen(false)} 
               className={`md:hover:text-blue-500 hover:text-blue-500 ${
                pathname === '/about' ? 'text-blue-500' : 'text-gray-700 md:text-white'
              }`}>
                درباره ما
               </Link>
            </li>
            ...
            <li>
              <Link
               ...
               onClick={()=> setIsOpen(false)} 
               className={`md:hover:text-blue-500 hover:text-blue-500 ${
                pathname === '/service' ? 'text-blue-500' : 'text-gray-700 md:text-white'
              }`}>
                خدمات ما
               </Link>
            </li>
            ...
            <li>
              <Link
                ...
                onClick={()=> setIsOpen(false)}
                className={`md:hover:text-blue-500 hover:text-blue-500 ${
                pathname === '/colleagues' ? 'text-blue-500' : 'text-gray-700 md:text-white'
              }`}>
                  همکاران ما
              </Link>
            </li>
            ...
            <li>
              <Link
                ...
                onClick={()=> setIsOpen(false)}
                className={`md:hover:text-blue-500 hover:text-blue-500 ${
                pathname === '/news' ? 'text-blue-500' : 'text-gray-700 md:text-white'
              }`}>
                  اخبار و مقالات
              </Link>
            </li>
            ...
            <li>
              <Link
                ...
                onClick={()=> setIsOpen(false)}
                className={`md:hover:text-blue-500 hover:text-blue-500 ${
                pathname === '/job' ? 'text-blue-500' : 'text-gray-700 md:text-white'
              }`}>
                  فرصت های شغلی
              </Link>
            </li>
            ...
            <li>
              <Link
                ...
                onClick={()=> setIsOpen(false)}
                className={`md:hover:text-blue-500 hover:text-blue-500 ${
                pathname === '/contact' ? 'text-blue-500' : 'text-gray-700 md:text-white'
              }`}>
                  تماس با ما
              </Link>
            </li>  
