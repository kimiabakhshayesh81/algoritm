...
//                     className="pb-8"
//                 >
//                     {differentJobs.map((jobs, index) => (
//                         <SwiperSlide key={index}>
//                             <div>
//                             <Image src={jobs.img} alt={jobs.title} />
//                             <p>{jobs.title}</p>
...
// const differentJobs = [
//   { img: back, title: 'Back End Developer' },
//   { img: devOps, title: 'DevOps Engineer' },
//   { img: front, title: 'Front End Developer' },
//   { img: ml, title: 'MlOps Engineer' },
// ]
...
//           <SwiperSlide key={index}>
//             <div className="h-full bg-white rounded-3xl shadow-md p-6 border border-gray-200 flex flex-col items-center text-center">
//               <Image
//                 src={job.img}
//                 alt={job.title}
...
//                 {job.title}
//               </p>
//               <button className="mt-auto px-4 py-2 bg-blue-700 text-white rounded-full text-sm hover:bg-blue-800 transition-all">
//                 مشاهده جزئیات
//               </button>
//             </div>
//           </SwiperSlide>
